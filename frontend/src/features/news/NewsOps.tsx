...
type Source = { id: string; name: string; status: string; health: string; latest_at: string; item_count: number; collected_count: number; error_count: number; errors: string[]; disabled: boolean; disabled_reason: string; summary: Record<string, unknown> };
