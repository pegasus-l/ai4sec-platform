...
// ============================================================================
// staticDemoAssets — 3 demo v12 assets for missing types (firmware/image/openx)
// Contract only has 'mirror' type assets. These supplement the missing types.
// ============================================================================
import type { ThreatAsset } from '../../types/threat';

export const staticDemoAssets: ThreatAsset[] = [
  {
    id: 'asset-atlas-firmware',
    title: 'Atlas Firmware / HDK',
    source: 'firmware',
    sourceType: 'firmware_package',
    category: 'firmware',
    url: '',
    summary: 'Atlas 固件与 HDK 包，涉及驱动、固件升级和设备初始化链路。',
    score: 72,
    status: '资产线索',
    tags: ['firmware'],
    raw: {},
    ...
    latest: '2026-07-10',
    confidence: 'inferred',
    repos: ['repo-ascend-deployer'],
    evidence: 'Atlas 固件与 HDK 包，涉及驱动、固件升级和设备初始化链路。',
  },
  {
    id: 'asset-mindie',
    title: 'MindIE AscendHub',
    source: 'ascendhub',
    sourceType: 'ascendhub',
    category: 'AscendHub',
    url: 'https://www.hiascend.com/developer/ascendhub/detail/af85b724a7e5469ebd7ea13c3439d48f',
    summary: 'MindIE 推理镜像，关联 MindIE-LLM、MindIE-Motor 和 CANN 运行环境。',
    score: 68,
    status: '资产线索',
    tags: ['ascendhub'],
    raw: {},
    ...
    label: 'MindIE',
    model: 'mindie',
    version: '3.0.0-800I-A3',
    count: '72849',
    latest: '2026/05/06',
    confidence: 'inferred',
    repos: ['repo-cann-ge'],
    evidence: 'MindIE 推理镜像，关联 MindIE-LLM、MindIE-Motor 和 CANN 运行环境。',
  },
  {
    id: 'asset-openx-ma5800',
    title: 'MA5800 OpenX Firmware',
    source: 'openx_huawei',
    sourceType: 'openx_huawei',
    category: 'OLTs',
    url: 'https://arquivos.openx.com.br/Huawei/OLTs/',
    summary: 'OpenX Huawei OLT 固件目录，适合固件解包和版本差异分析。',
    score: 65,
    status: '资产线索',
    tags: ['openx'],
    raw: {},
    ...
    confidence: 'weak',
    repos: [],
    evidence: 'OpenX Huawei OLT 固件目录，适合固件解包和版本差异分析。',
  },
];
