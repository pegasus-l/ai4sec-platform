...
interface ShellProps {
  activeDomain?: string;
  onDomainChange?: (domain: TopTabId) => void;
}

export function Shell({ children, activeDomain = 'news', onDomainChange }: PropsWithChildren<ShellProps>) {
  return <div className={`shell ${activeDomain}-shell`}>
