...
from ai4sec_platform.domains.vulnerabilities.pipelines import vulnerability_batched_full_discovery_pipeline, vulnerability_event_pipeline, vulnerability_external_discovery_pipeline, vulnerability_full_discovery_pipeline, vulnerability_knowledge_pipeline, vulnerability_pattern_pipeline, vulnerability_raw_pipeline
...
def default_registry() -> PipelineRegistry:
    ...
    registry.register(vulnerability_pattern_pipeline())
    return registry
