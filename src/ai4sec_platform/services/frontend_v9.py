...
def page_contract(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "threat": {
            ...
            "cveCompare": latest_artifact_preview(conn, "huawei_cve_compare"),
            "attackSurface": latest_artifact_preview(conn, "huawei_attack_surface"),
            "attackSurfaceCompare": latest_artifact_preview(conn, "huawei_attack_surface_compare"),
...
def static_file_contract(conn: sqlite3.Connection, path: str) -> Any:
    ...
    mapping = {
        ...
        "threat/cve_compare.json": data["threat"]["cveCompare"],
        "threat/attack_surface.json": data["threat"]["attackSurface"],
        "threat/attack_surface_compare.json": data["threat"]["attackSurfaceCompare"],
