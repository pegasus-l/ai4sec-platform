...
def test_threat_semantic_review_payload_contains_old_agent_judgement_inputs() -> None:
    target = {
        "id": 1,
        ...
        "payload": {
            "legacy_attack_surface": {"grade": "A", "breakdown": {"historical_cve": 15}},
            "scoring": {"score": 92},
    ...
    assert payload["legacy_attack_surface"]["grade"] == "A"
